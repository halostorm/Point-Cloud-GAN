...
class DataLoader(object):
    def __init__(self, params, y=0, do_standardize=False, do_augmentation=False,
                 n_obj=5):  # batch_size, data, labels, shuffle=True, repeat=True:
        ...
        self.prep2 = (
            lambda x, y: augmentd_gpu(self.prep1(x, y)[0], y, self.batch_size)) if do_augmentation else self.prep1
