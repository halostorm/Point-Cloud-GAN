...
parsed[
    'out_dir'] = './results/aug_points_{0}_opt_{1}_lr_{2}_{3}_c_{4}_z1_{5}_z2_{6}_d_{7}_clip_{8}__pool_{9}_type_{10}_gradpen_{11}_Arc_{12}_invact_{16}_N_{13}_odim_{14}_obj_{15}'.format(
